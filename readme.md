...
- [Core Brain Systems (14 Modules)](#-core-brain-systems-14-modules)
...
| Single model, single purpose | **14 brain modules** coordinating via Global Workspace |
...
|----------|-------------|
| 🧠 **Cognition** | 14 brain modules — self-awareness, active inference, dreaming, curiosity, learning, procedural memory, episodic memory, vector memory, code intelligence, cyber reasoning |
